    ...
    <div className="min-h-screen flex flex-col items-center justify-center text-[var(--foreground)] px-4">
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 bg-white/80 p-8 rounded-xl shadow max-w-3xl">
        <div className="w-80 flex-shrink-0 flex justify-center">
          <Image
            src="/profile.jpeg" // Place your photo in /public/profile.jpeg
            alt="Portrait of Ysabella Vargas"
            width={300}
            height={300}
        ...
        <div className="text-xl font-serif text-center md:text-left">
          <p>
            Hi! I&apos;m Yssie, a Junior at Tufts University, pursuing degrees in Computer Science and Biology. I am passionate about building technology to advance medical research and improve healthcare systems. My interests lie at the intersection of data science, bioinformatics, and software development.
            <br /> <br />
